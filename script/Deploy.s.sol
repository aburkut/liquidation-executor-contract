...
contract Deploy is Script {
    function run() external returns (address executor) {
        ...
        allowed[1] = 0xBBBBBbbBBb9cC5e90e3b3Af64bdAF62C37EEFFCb;
        allowed[2] = 0x7d2768dE32b0b80b7a3454c06BdAc94A69DDc7A9;
        allowed[3] = 0x000000000004444c5dc75cB358380D2e3dE08A90;

        vm.startBroadcast();
        executor = address(
            new LiquidationExecutor(owner, operator, weth, aavePool, balancer, paraswap, uniV2, uniV3, allowed)
        );
        vm.stopBroadcast();
    }
}
